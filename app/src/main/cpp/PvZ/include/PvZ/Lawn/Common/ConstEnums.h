...
enum BossPart { BOSS_PART_BACK_LEG = 0,
...
enum GameScenes { SCENE_LOADING = 0,
                  SCENE_MENU = 1,
                  SCENE_LEVEL_INTRO = 2,
                  SCENE_PLAYING = 3,
                  SCENE_ZOMBIES_WON = 4,
...
enum SeedType { // 直接从WP复制过来的，怀疑其中有错误，因为TV有重型武器关卡，多了三个种子
    ...
    SEED_ZOMBIE_SUNFLOWER_HEAD,
    SEED_ZOMBIE_TORCHWOOD_HEAD,
    SEED_ZOMBIE_EXPLODE_O_NUT_HEAD,
...
enum ZombiePhase {
    ...
    PHASE_IMP_PRE_RUN,
    PHASE_IMP_RUNNING,
    PHASE_IMP_GETTING_TACKLE,
    PHASE_IMP_POPPING,
    PHASE_FOOTBALL_WALKING,
    PHASE_FOOTBALL_PRE_CHARGING,
    PHASE_FOOTBALL_CHARGING,
    PHASE_FOOTBALL_TACKLE,
    PHASE_JACKSON_SNAPPING_FINGERS,
    PHASE_SUNFLOWER_HEAD_SPAWNING
};
enum ZombieType {
    ZOMBIE_INVALID = -1,
    ZOMBIE_NORMAL = 0,
