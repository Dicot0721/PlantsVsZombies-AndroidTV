...
enum EventType : uint8_t {
    ...
    EVENT_SERVER_BOARD_PLANT_SHOOTER_LAUNCH,
    EVENT_SERVER_BOARD_PLANT_FINDTARGETANDFIRE,
    EVENT_SERVER_BOARD_PLANT_KERNELPLUT_FINDTARGETANDFIRE,
    EVENT_SERVER_BOARD_PLANT_PINGPONG_ANIMATION, // 似乎无用，先不同步
    EVENT_SERVER_BOARD_PLANT_OTHER_ANIMATION,
    EVENT_SERVER_BOARD_PLANT_FIRE,
    EVENT_SERVER_BOARD_PLANT_ADD,
    EVENT_SERVER_BOARD_PLANT_DIE,
    EVENT_SERVER_BOARD_PLANT_DO_SPECIAL,
    ...
    EVENT_SERVER_BOARD_ZOMBIE_HUGE_WAVE,
    EVENT_SERVER_BOARD_ZOMBIE_YUCKY_SETROW,

    EVENT_SERVER_BOARD_LAWNMOWER_STRART,
