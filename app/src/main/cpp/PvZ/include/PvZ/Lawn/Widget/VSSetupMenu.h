...
public:
    ...
    static constexpr SeedType msShufflePools[9][8] = {
        // plant pools - normal
        {SEED_PEASHOOTER, SEED_REPEATER, SEED_CABBAGEPULT, SEED_KERNELPULT, SEED_SNOWPEA, SEED_NONE, SEED_NONE, SEED_PEASHOOTER},
        {SEED_WALLNUT, SEED_CHERRYBOMB, SEED_POTATOMINE, SEED_JALAPENO, SEED_SQUASH, SEED_NONE, SEED_PEASHOOTER, SEED_PEASHOOTER},
        {SEED_CHOMPER, SEED_GRAVEBUSTER, SEED_THREEPEATER, SEED_SPIKEWEED, SEED_STARFRUIT, SEED_MELONPULT, SEED_GARLIC, SEED_NONE},
        // plant pools - has coffee
        {SEED_PUFFSHROOM, SEED_FUMESHROOM, SEED_SCAREDYSHROOM, SEED_PEASHOOTER, SEED_NONE, SEED_NONE, SEED_PEASHOOTER, SEED_PEASHOOTER},
        {SEED_WALLNUT, SEED_HYPNOSHROOM, SEED_ICESHROOM, SEED_DOOMSHROOM, SEED_JALAPENO, SEED_SQUASH, SEED_NONE, SEED_PEASHOOTER},
        {SEED_GRAVEBUSTER, SEED_SPIKEWEED, SEED_GARLIC, SEED_NONE, SEED_PEASHOOTER, SEED_PEASHOOTER, SEED_PEASHOOTER, SEED_PEASHOOTER},
        // zombie pools
        {SEED_ZOMBIE_NORMAL, SEED_ZOMBIE_TRASHCAN, SEED_ZOMBIE_TRAFFIC_CONE, SEED_ZOMBIE_POLEVAULTER, SEED_ZOMBIE_NEWSPAPER, SEED_ZOMBIE_SUPER_FAN_IMP, SEED_NONE, SEED_PEASHOOTER},
        {SEED_ZOMBIE_TRASHCAN, SEED_ZOMBIE_PAIL, SEED_ZOMBIE_DANCER, SEED_ZOMBIE_LADDER, SEED_ZOMBIE_FOOTBALL, SEED_ZOMBIE_BUNGEE, SEED_ZOMBIE_DIGGER, SEED_NONE},
