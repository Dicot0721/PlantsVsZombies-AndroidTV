...
#if PVZ_VERSION == 111
    game_patches::whackAZombieNormalSpeed = homura::Patcher::CreateWithStr(libGameMain, 0x183448, "4F F0 01 00");
    game_patches::repairShopA = homura::Patcher::CreateWithStr(libGameMain, 0x1C3B06, "05 E0");
    game_patches::repairShopB = homura::Patcher::CreateWithStr(libGameMain, 0x1C3C6C, "06 E0");
    game_patches::autoPickupSeedPacketDisable = homura::Patcher::CreateWithStr(libGameMain, 0x1C6068, "16");
#elif PVZ_VERSION == 115
    game_patches::whackAZombieNormalSpeed = homura::Patcher::CreateWithStr(libGameMain, 0x1814F0, "4F F0 01 00");
    game_patches::repairShopA = homura::Patcher::CreateWithStr(libGameMain, 0x1C1BB6, "05 E0");
    game_patches::repairShopB = homura::Patcher::CreateWithStr(libGameMain, 0x1C1D1C, "06 E0");
    game_patches::autoPickupSeedPacketDisable = homura::Patcher::CreateWithStr(libGameMain, 0x1C4114, "16");
#endif // PVZ_VERSION
